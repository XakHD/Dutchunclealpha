...
import banner3 from '@/public/images/character.png'
...
export default function ModalVideo({
  ...
  return (
    <div>
      ...
      {/* Video thumbnail changed to Photo */}
      <div>
        {/* original div <div className="relative flex justify-center items-center" data-aos="fade-up" data-aos-delay="200">  */}
        <div className="relative flex justify-center items-center" data-aos="fade-up" data-aos-delay="200">
           <Image className='opacity-20' src={logo} alt={thumbAlt} /> 
